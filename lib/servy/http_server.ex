defmodule Servy.HttpServer do
  ...
  @doc """
  starts the server n the given `port` of localhost
  """
  def start(port) when is_integer(port) and port > 1023 do
    ...
    # `reuseaddr: true` - allows reusing the address if the listener crushes
  ...
  def accept_loop(listen_socket) do
    ...
    # loop back and wait to accept the next connection
    accept_loop(listen_socket)
  end

  @doc """
  Receives the request n the `client_socket` and
